...
const Home = () => {
  ...
  const stats = [
    ...
    { number: '10+', label: 'Fortune Partnerships - Trusted by industry leaders to deliver exceptional technical talent for mission-critical projects and digital transformation initiatives.' },
